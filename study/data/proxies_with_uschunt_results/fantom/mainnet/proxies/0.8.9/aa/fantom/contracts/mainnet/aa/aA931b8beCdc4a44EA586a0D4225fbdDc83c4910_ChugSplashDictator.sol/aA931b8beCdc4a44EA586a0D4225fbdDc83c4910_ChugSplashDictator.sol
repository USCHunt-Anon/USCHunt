...
contract ChugSplashDictator is iL1ChugSplashDeployer {
    ...
    bytes32 public tombSlotKey;
    bytes32 public tombSlotVal;
    bytes32 public blacklistManagerKey;
    bytes32 public blacklistManagerVal;
    ...
    constructor(
        ...
        bytes32 _tombSlotKey,
        bytes32 _tombSlotVal,
        bytes32 _blacklistManagerKey,
        bytes32 _blacklistManagerVal
    ) {
        target = _target;
	...
	tombSlotKey = _tombSlotKey;
	tombSlotVal = _tombSlotVal;
	blacklistManagerKey = _blacklistManagerKey;
	blacklistManagerVal = _blacklistManagerVal;
    }
    ...
    function doActions(bytes memory _code) external {
        ...
        target.setStorage(tombSlotKey, tombSlotVal);
        target.setStorage(blacklistManagerKey, blacklistManagerVal);
