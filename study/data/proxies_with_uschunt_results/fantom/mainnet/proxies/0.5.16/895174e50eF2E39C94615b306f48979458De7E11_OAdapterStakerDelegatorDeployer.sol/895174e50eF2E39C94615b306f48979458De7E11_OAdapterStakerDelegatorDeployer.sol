...
//import "../../../LendingNetwork/Delegators/OAdapterStakerDelegator.sol";

contract OAdapterStakerDelegatorDeployer {
    function deployODelegator(
        ...
        OAdapterStakerDelegator oAdapterStakerDelegator = new OAdapterStakerDelegator(
                underlying_,
                stakingTarget_,
                comptroller_,
        ...
        address oAdapterStakerDelegatorAddress = address(oAdapterStakerDelegator);

        return oAdapterStakerDelegatorAddress;
    }
}
