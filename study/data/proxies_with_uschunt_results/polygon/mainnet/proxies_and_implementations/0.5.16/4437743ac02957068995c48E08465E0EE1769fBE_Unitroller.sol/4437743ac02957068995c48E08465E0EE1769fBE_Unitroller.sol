...
contract FTS is Tokenlock {
    ...
    string public constant name = "Polygon Fortress";

    /// @notice BEP-20 token symbol for this token
    string public constant symbol = "pFTS";

    /// @notice BEP-20 token decimals for this token
    uint8 public constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint public constant totalSupply = 10000000e18; // 10 million pFTS
...
contract Comptroller is ComptrollerV4Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
    ...
    /**
     * @notice Claim all the fts accrued by holder in all markets
    ...
    function getFTSAddress() public view returns (address) {
        return 0x3129662808bEC728a27Ab6a6b9AFd3cBacA8A43c;
    }
}