...
contract TinyHeroStats is ITinyHeroStats, OwnableUpgradeable {
    address public nft;
    ...
    function stats(uint256 tokenId) external override view returns (uint16[] memory pvpStats) {
        ...
        pvpStats[7] = _attribute.Exp;
        pvpStats[8] = _attribute.Skills;
        pvpStats[9] = _attribute.Productivity;
    }
