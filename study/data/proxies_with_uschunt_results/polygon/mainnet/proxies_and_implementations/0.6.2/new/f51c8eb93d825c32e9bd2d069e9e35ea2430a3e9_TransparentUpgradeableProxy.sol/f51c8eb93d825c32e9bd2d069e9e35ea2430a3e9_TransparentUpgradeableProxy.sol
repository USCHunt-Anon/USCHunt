...
contract GamingChickAuction is OwnableContract, IERC721Receiver, Initializable{
    ...
    function initialize() public initializer{
        ...
        // pool.token = 0xDD81bfB457E27e36043aC46725EA0fBd2013210d; // test
        pool.token = 0x8580a90f6E378dB283ddb8af06356a962551e89A;
        poolInfo.push(pool);

        // pool.token = 0xbEf15aA877adEd8F2e72e9dcc188AeF6Adb3E8e6; // test
        pool.token = 0x388EB34b54fE92e944b81A23f8e60146cA838180;
        poolInfo.push(pool);

        // pool.token = 0x97d48881A7C5c36d103a54Df537c105E8348d4f4; // test
         pool.token = 0x4F1e6318aCc9Ee33c88f0E3E3578D5aD62E19285;
        poolInfo.push(pool);

        // pool.token = 0x7Ac58167E25227B22EeA7bBe7F78ada1e60A8390; // test 
        pool.token = 0x4f17c6514B9Ca3aBccfDefd12DF2dfA195A76dC4;
        poolInfo.push(pool);
