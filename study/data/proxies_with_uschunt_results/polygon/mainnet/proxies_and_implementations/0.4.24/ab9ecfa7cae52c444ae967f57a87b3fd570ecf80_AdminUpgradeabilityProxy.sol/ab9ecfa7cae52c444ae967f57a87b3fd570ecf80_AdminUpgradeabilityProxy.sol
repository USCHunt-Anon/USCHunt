...
// File: contracts/USDSImplementationV3.sol
...
/**
 * @title USDSImplementationV3
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing USDSImplementation
...
contract USDSImplementationV3 {
    ...
    string public constant name = "Simple USD"; // solium-disable-line
    string public constant symbol = "USDS"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all USDS at the contract address.
     * This sends the USDS tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimUSDS() external onlyOwner {
