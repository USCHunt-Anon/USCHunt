...
contract ComptrollerStorageOlaV0_01 is ComptrollerV5Storage {
    ...
    // @note an address to turn to in order to distribute tokens for participation
...
contract ComptrollerStorageOlaV0_02 is ComptrollerStorageOlaV0_01 {
    ...
    // @note An address to turn to in order to check if an account is approved for specific actions.
