...
contract ERC20TokenImplementation is Context, IERC20, Initializable {
    ...
    */
    ...
    //Polygon start=================
    function getChildChainManagerProxy() external view returns (address) {
   ...
   */
    ...
    function updateChildChainManager(address newChildChainManagerProxy) external {
        ...
        require(msg.sender == _owner, "You're not allowed");
    ...
    function deposit(address user, bytes calldata depositData) external {
        require(msg.sender == _childChainManagerProxy, "You're not allowed to deposit");
