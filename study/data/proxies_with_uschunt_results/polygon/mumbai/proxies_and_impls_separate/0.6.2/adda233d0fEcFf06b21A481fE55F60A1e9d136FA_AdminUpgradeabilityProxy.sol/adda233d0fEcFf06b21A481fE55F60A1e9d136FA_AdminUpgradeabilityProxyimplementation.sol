...
// File: contracts/utils/IERC165Upgradeable.sol
...
// File: contracts/utils/ERC165Upgradeable.sol
...
// File: contracts/AccessControlGET.sol
...
contract AccessControlGET is Initializable, AccessControlUpgradeable {
    ...
    function __AccessControlMock_init() public initializer {
        __Context_init_unchained();
        __ERC165_init_unchained();
        __AccessControl_init_unchained();
    ...
    function __AccessControlMock_init_unchained() internal initializer {
        ...
        _setupRole(GET_ADMIN, _msgSender());
        _setupRole(FACTORY_ROLE, _msgSender());
        _setupRole(GET_GOVERNANCE, _msgSender());
