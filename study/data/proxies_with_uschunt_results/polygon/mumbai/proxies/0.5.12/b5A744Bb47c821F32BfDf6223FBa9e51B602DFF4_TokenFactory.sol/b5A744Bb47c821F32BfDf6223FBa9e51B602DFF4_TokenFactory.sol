...
// File @sygnum/solidity-base-contracts/contracts/role/interface/IBaseOper[email protected]
...
contract SygnumTokenV1 is SygnumToken {
    ...
    function initializeContractsAndConstructor(
        ...
        require(!initializedMetadataUpgrade, "SygnumTokenV1: already initialized");
        ...
        initializeSygnumTokenV1(_tokenURI);
    }

    function initializeSygnumTokenV1(string memory _tokenURI) public {
