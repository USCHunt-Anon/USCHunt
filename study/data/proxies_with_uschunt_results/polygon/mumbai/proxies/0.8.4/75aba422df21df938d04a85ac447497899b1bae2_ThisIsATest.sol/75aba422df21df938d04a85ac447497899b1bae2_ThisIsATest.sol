...
// File contracts/ThisIsATest.sol
...
contract ERC721ContractWrapper is Proxy {
    address internal constant _IMPLEMENTATION_ADDRESS = 0xC29Cbf78FA45067287489D72338e326Dd4Fcf817;
    bytes32 internal constant _IMPLEMENTATION_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;
...
contract ThisIsATest is ERC721ContractWrapper {
  constructor(
    string memory _uri,
    string memory _name,
    string memory _symbol,
