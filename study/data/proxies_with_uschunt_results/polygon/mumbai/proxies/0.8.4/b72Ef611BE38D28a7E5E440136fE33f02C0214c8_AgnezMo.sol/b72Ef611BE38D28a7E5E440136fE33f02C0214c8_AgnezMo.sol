...
// File pre_contracts/AgnezMo.sol
...
contract ERC1155ContractWrapper is Proxy {
    address internal constant _IMPLEMENTATION_ADDRESS = 0x60F982fE499c571114604f55c4d09F966F0760eB;
    bytes32 internal constant _IMPLEMENTATION_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;
...
contract AgnezMo is ERC1155ContractWrapper {
  constructor(
    string memory _name,
    string memory _symbol,
    uint256 _maxSupplyPerToken,
...
// File @openzeppelin/contracts-upgradeable/utils/cryptography/ECDSAUpgradeable.sol@v4.5.2
...
// File pre_contracts/ContextMixinUpgradable.sol
 ...
 */
abstract contract ContextMixinUpgradable is Initializable {
...
// File pre_contracts/PlatformUpgradable.sol
...
contract PlatformUpgradable is Initializable {
...
// File pre_contracts/ERC1155OpenseaUpgradable.sol
...
abstract contract ERC1155OpenseaUpgradable is ERC1155SupplyUpgradeable, OwnableUpgradeable, ContextMixinUpgradable, PlatformUpgradable {
    string private _contractURI;
    mapping(uint => string) public _tokenURI;

    address proxyRegistryAddress;

    function __ERC1155Opensea_init() public virtual onlyInitializing {
        __Platform_init_unchained();
        __ContextMixin_init_unchained();
        __Ownable_init_unchained();
    ...
    {
        return ContextMixinUpgradable.msgSender();
    }
    ...
    function setBaseURI(uint _id, string memory _uri) external onlyOwner {
        _tokenURI[_id] = _uri;
        emit URI(_uri, _id);
    }
...
// File pre_contracts/ERC1155YUpgradable.sol
...
contract ERC1155YUpgradable is ERC1155OpenseaUpgradable {
    ...
    function __ERC1155Y_init(
        ...
        require(_platformRoyalty >= minPlatformRoyalty, string(abi.encodePacked("Platform royalty must be equal or bigger than ", minPlatformRoyalty)));
        require((_platformRoyalty + _creatorRoyalty) == 10000, "Addition of platform and creator royalty must be 10000");
        require(_tokenPrice >= minTokenPrice, string(abi.encodePacked("Token price at least must be ", minTokenPrice, " wei (MATIC)")));
...
// File pre_contracts/ERC1155YImpl.sol
