...
contract Diamond {
    constructor(address _contractOwner, address _diamondCutFacet) payable {
        ...
        LibDiamond.setGameServerAddress(_contractOwner); // TODO
        LibDiamond.setName("Crypto Unicorns");
        LibDiamond.setSymbol("UNICORNS");
        ...
        LibDiamond.setGenesisEggHatchUnlockTime(1637370000); //  UTC: Saturday, November 20, 2021 1:00:00 AM

        // This is the REAL presale timestamp for prod
        // LibDiamond.setGenesisEggPresaleUnlockTime(1637024400); //  UTC: November 16, 2021 1:00:00 AM

        //  Test timestamp - Mumbai only!
        LibDiamond.setGenesisEggPresaleUnlockTime(1636707600); //  Friday, November 12, 2021 1:00:00 AM GMT-08:00
...
library LibDiamond {
    ...
    uint256 constant ERC721_GENESIS_TOKENS = 10000;
    ...
    struct DiamondStorage {
        ...
        //TODO IMPORTANT: This should be constant and hardcoded ?
        address WethTokenAddress;
        // Unicorn token -> DNA mapping. DNA is represented by a uint256.
        mapping(uint256 => uint256) unicorn_dna;
    }
