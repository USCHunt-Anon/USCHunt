...
contract NFTFactory is Initializable, ERC1155Upgradeable, AccessControlUpgradeable , IERC2981 {
    ...
    */
    function createNFT (address _artist, string memory _name, uint256 _amount, uint24 _fee) virtual public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    */
    function setOwnersURI(string memory _owners_uri) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    * @dev Uri setter 
    */
    function setUrl(string memory _url) virtual public onlyRole(DEFAULT_ADMIN_ROLE) {
        _setURI(_url);
        emit URI(_url, 0);
    }

    function setNewAdmin(address _newAdmin) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    */
     ...
     */
    function sendValueCall(address payable recipient, uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(address(this).balance >= amount, "Address: insufficient balance");
