...
// flattened :  Friday, 30-Jul-21 20:00:04 UTC
...
abstract contract ABase is IBase, AStorage {
    ...
    function containsOwnerAddress(
        ...
        address ownerAddress = owner().userAddress;
        address[] memory additionalUserAddresses = addressToAddressArrayStorage[ADDITIONAL_USER_ADDRESSES][ownerAddress];
        for (uint i = 0; i < addresses.length; i++) {
