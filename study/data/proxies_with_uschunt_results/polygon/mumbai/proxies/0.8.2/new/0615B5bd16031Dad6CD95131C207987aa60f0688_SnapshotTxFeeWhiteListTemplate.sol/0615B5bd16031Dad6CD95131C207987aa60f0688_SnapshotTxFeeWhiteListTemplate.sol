...
// File contracts/templates/SnapshotTxFeeWhiteListTemplate.sol
...
contract SnapshotTxFeeWhiteListTemplate is SnapshotFeature, PausableWithWhitelistFeature, TxFeeFeature {
    function initialize(
        string memory name_, 
        string memory symbol_, 
        uint8 decimals_, 
