...
// File @openzeppelin/contracts-upgradeable/token/ERC20/extensions/IERC20MetadataUpgr[email protected]
...
contract BlacklistBurnSnapshotTxFeeTemplate is 
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(SnapshotFeature, BlacklistFeature, TxFeeFeature) {
