...
library LibDiamond {
    ...
    bytes32 constant CRYPTARTS_STORAGE_POSITION = keccak256("cryptarts.standard.cryptarts.storage");
    ...
    function cryptartsStorage() internal pure returns (CryptartsStorage storage ds) {
