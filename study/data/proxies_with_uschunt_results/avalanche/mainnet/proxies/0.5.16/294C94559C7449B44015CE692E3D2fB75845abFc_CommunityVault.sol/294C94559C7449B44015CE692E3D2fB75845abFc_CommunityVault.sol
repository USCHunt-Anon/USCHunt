...
// ////-Copyright-Text: OpenZeppelin, 2021
...
contract CommunityVault is CommunityVaultStorage, ECDSA {
        ...
        returns (uint256)
    {
        ...
        uint256 curBlockNumber = block.timestamp;
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint96 oldVotes, uint96 newVotes) internal {
        uint32 blockTimestamp = safe32(block.timestamp, "CommunityVault::_writeCheckpoint: block number exceeds 32 bits");
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint96) {
        require(blockNumber < block.timestamp, "CommunityVault::getPriorVotes: not yet determined");
