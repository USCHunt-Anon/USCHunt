...
// File: contracts/PUSDImplementation.sol
...
/**
 * @title PUSDImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing PUSDImplementation
...
contract PUSDImplementation {
    ...
    string public constant name = "Peacock USD"; // solium-disable-line
    string public constant symbol = "PUSD"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all PUSD at the contract address.
     * This sends the PUSD tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimPUSD() external onlyOwner {
