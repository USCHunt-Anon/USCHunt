...
/**
 * @title Ola's CEther Contract
 * @notice CToken which wraps Native coins
 * @author Ola
 * V05 changes :
 * -- Added admin restriction to 'sweepTokens'
 */
contract CEtherV0_05 is CToken, CEtherStorageV0_01 {
    /**
    ...
    function sweepToken(EIP20NonStandardInterface token) external {
        require(msg.sender == admin, "ONative::sweepToken: Only admin");
        require(address(token) != underlying, "ONative::sweepToken: can not sweep underlying token");
...
//import"../CEtherV0_05.sol";

/**
 * @title Ola's ONativeDelegate Contract V0_05
 * @notice OTokens which wrap a native coin underlying and are delegated to
 * @author Ola
 */
contract ONativeDelegateV0_05 is CEtherV0_05, CDelegateInterface {
    /**
