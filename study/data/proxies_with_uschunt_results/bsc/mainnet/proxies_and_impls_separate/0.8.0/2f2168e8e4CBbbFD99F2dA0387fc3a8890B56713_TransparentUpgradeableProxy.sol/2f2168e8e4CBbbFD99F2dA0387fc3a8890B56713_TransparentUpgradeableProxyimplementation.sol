...
contract Donate5 is Initializable, OwnableUpgradeable {
    ...
    address public _service = 0x1C2008856EE53d7477d11fCa8b31A7CD88f1B444;
    address public _donate3 = 0xCB30aeA1a210F10844eDE4159ED1f5e1d7a6b140; 
    ...
    function initialize()public initializer{
        ...
        purchase.push(1 * 10**18);
        purchase.push(3 * 10**18);
        purchase.push(5 * 10**18); // 500 USDT
	}
