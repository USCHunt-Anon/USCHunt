  ...
  IMCGRandConsumer
{
  ...
  function setBreakdownPercent(
    ...
    require(
      _deLottoPercent + _deGrandPercent + _burnPercent == 10000,
      "Invalid percent"
    );
...
contract StandardLotteryV2 is MCGLotterysAbstract {
  ...
  function __StandardLottery_init(
    ...
    deGrandAddress = 0xB9ea702EFE37a4546708e21ca44Fe51444f70552;

    maxNumberTicketsPerBuyOrClaim = 100;

    maxPriceTicketInMCG = 100000 * (10**9);
    minPriceTicketInMCG = 10000 * (10**9);

    breakDownDeLottoPot = 6000; // 50%
  ...
  function buyTickets(
    ...
    mcgToken.safeTransferFrom(
      address(msg.sender),
      DEAD_ADDRESS,
      amountMCGToTransfer.sub(deLottoAmount).sub(deGrandAmount)
    );
  ...
  function claimTickets(
    ...
    // Initializes the rewardInMCGToTransfer
  ...
  function setMinAndMaxTicketPriceInMCG(
    ...
    minPriceTicketInMCG = _minPriceTicketInMCG * (10**9);
    maxPriceTicketInMCG = _maxPriceTicketInMCG * (10**9);
  }
