...
//import"./libs...IERC721Metadata.sol";
...
contract NFTCards is ERC721, Ownable {
    ...
    address public tokenAddress = 0xEED0d0A71382FABc3ceD60831860Dd55BF63E511;
    ...
    uint256 public mintingPrice = 2*10**18;
    uint256 public mintingPriceWithRef = 1*10**18;
    ...
    function getTokenPrice3(address token1, uint256 amount) public view returns(uint256)
    {
    ...
    function getTokenPrice1() public view returns(uint256, uint256)
    {
    ...
    function getTokenPrice2() public view returns(uint256, uint256)
    {
        address _pancakeSwapV2Pair = getPairAddress(stableCoinAddress);
        IpancakeswapV2Pair pair = IpancakeswapV2Pair(_pancakeSwapV2Pair);
        (uint256 Res0, uint256 Res1,) = pair.getReserves();
...
interface INFTCard {
    ...
    function addWhitelistByToken(address account, bool value) external;
