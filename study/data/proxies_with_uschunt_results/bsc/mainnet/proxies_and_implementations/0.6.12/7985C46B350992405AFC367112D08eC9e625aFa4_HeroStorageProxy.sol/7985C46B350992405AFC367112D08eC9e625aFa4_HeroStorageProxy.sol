...
contract HeroStorage is ERC721WithBalancesLike1155, Constants, DungeonsWhitelist, Initializable{
    ...
    function getDungeonAddress(uint256 tokenId) view public returns(address){
        return dungeon[tokenId];
    }
...
contract ERC721WithBalancesLike1155 is ManagerIsOwner, IBalancesLikeERC1155, ERC721
{
    ...
    function mint(address to, uint256[10] memory keys, uint256[10] memory amounts)
        public override
        onlyManager
        returns (uint256)
    {
    ...
    function setMany(uint256 tokenId, uint256[10] memory keys, uint256[10] memory values)
        public override
        onlyManager tokenIdExists(tokenId)
    {
