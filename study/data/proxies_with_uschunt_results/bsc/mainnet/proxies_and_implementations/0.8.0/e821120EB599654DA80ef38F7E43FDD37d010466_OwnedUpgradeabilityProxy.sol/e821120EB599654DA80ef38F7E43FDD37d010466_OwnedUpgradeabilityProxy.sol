...
contract OwnedUpgradeabilityProxy {
    ...
    bytes32 private constant maintenancePosition = keccak256("com.anchor.proxy.maintenance");
    // Storage position of the address of the current implementation
    bytes32 private constant implementationPosition = keccak256("com.anchor.proxy.implementation");
    // Storage position of the owner of the contract
    bytes32 private constant proxyOwnerPosition = keccak256("com.anchor.proxy.owner");
...
contract LotteryNFT is ERC721, Ownable {
    ...
    constructor() ERC721("Anchor Lottery Ticket", "ALT") {}
