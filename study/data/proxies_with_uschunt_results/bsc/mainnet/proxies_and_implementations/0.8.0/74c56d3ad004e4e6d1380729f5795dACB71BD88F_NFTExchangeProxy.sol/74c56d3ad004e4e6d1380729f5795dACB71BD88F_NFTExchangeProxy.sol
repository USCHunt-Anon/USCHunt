...
//import{ AOG1155 } from "../1155/AOG1155.sol";
//import{ AOG721 } from "../721/AOG721.sol";
...
contract Upgradable is ReentrancyGuarded {
    ...
    address public aog1155Address;
    address public aog721Address;
    ...
    function mint(
        ...
        if (_tokenType == 0) {  // ERC721
            tokenId = AOG721(aog721Address).mint(_receiver, _tokenId, _data);
        } else {    // ERC1155
            tokenId = AOG1155(aog1155Address).mint(_receiver, _tokenId, _amount, "", _data);
        }
        return tokenId;
    }
    ...
    function mintBatch721(
        ...
        require(isAdmin(msg.sender) || msg.sender == superAdmin, "AOG: Caller is not admin");
        ...
        AOG721(aog721Address).mintBatch(msg.sender, _tokenIds, bytes(_str[1]));
    ...
    function transfer(
        ...
        if (_tokenType == 0) {  // ERC 721
            AOG721(aog721Address).safeTransferFrom(_seller, _buyer, _tokenId, _data);
        } else {
            AOG1155(aog1155Address).safeTransferFrom(_seller, _buyer, _tokenId, _amount, _data);
        }
    }
...
contract AOG721 is Ownable, ERC721Enumerable {
    ...
    Counters.Counter indexId;           // current token Id minted on Galler
...
contract AOG1155 is Ownable, ERC1155{
...
contract NFTExchange is Upgradable {
    ...
    * set the address of the super admin
    ...
    function setAOG721Address(address _aog721Address) public onlySuperAdmin {
        aog721Address = _aog721Address;
    }

    /** set the address of the 1155 token */
    function setAOG1155Address(address _aog1155Address) public onlySuperAdmin {
        aog1155Address = _aog1155Address;
    }
