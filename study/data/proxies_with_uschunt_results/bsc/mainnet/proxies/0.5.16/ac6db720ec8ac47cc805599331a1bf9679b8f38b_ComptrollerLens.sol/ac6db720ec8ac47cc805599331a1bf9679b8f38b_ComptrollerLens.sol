...
// File contracts/ComptrollerLensInterface.sol
...
// File contracts/Lens/ComptrollerLens.sol
...
contract ComptrollerLens is ComptrollerLensInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getHypotheticalAccountLiquidity(
        ...
        for (uint i = 0; i < assetsCount; ++i) {
            ...
            vars.oraclePriceMantissa = PriceOracle(0xC0bfA73645e2B17f6b32AAc5506299300A7D57Ec).getUnderlyingPrice(asset);
