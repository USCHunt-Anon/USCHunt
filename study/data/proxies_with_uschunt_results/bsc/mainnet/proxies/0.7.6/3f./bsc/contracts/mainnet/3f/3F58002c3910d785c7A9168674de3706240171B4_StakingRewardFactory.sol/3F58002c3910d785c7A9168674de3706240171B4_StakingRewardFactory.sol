...
contract StakingRewardFactory{
    ...
    function createStakingReward(address _stakingToken, address _rewardsToken) external returns (address) {
        CustomStakingReward staking = new CustomStakingReward();

        staking.initialize(_stakingToken, _rewardsToken, msg.sender);
