...
contract Alora is ERC20Upgradeable {
    ...
    address public reserveAllocation;
    ...
    constructor(address _teamAllocation,address _reserveAllocation,address _reservePool) {
...
function setTeamAllocation(address _teamAllocation) public onlyOwner {
        teamAllocation = _teamAllocation;
    }
    function setReserveAllocation(address _reserveAllocation) public onlyOwner {
        reserveAllocation = _reserveAllocation;
    }
    ...
    */
    function _addLiquidity(uint256 _amount) public payable onlyOwner {
