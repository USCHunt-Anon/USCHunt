...
// File contracts/interface/IERC20MetadataUpgradeable.sol
...
// File contracts/NodeGrid.sol

pragma solidity ^0.8.0;
interface IAloraManager {
...
contract AloraNode is ERC20Upgradeable {
    ...
    address public aloraNodeManagerAddress;
    ...
    function setaloraNodeManagerAddress(address _aloraNodeManagerAddress) public onlyOwner {
        aloraNodeManagerAddress = _aloraNodeManagerAddress;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override {
        ...
        if (!isExcludedFromFee[from] && !isExcludedFromFee[to]) {
            uint256 taxAmount = 0;
            if(_isSelling && checkNodeBeforeSell && aloraNodeManagerAddress != address(0) && !_inSwapAndLiquify) {
                IAloraManager mgr = IAloraManager(aloraNodeManagerAddress);
