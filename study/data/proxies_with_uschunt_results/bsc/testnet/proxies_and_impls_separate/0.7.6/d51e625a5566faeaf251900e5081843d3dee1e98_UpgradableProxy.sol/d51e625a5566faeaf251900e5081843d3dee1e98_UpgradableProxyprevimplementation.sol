...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
       address(0x2a39B38485e246057B196dc553B127c83e2b4160) // DollarRewardPool
    ];
    ...
    function initialize(
        ...
        shareRewardPoolExpansionRate = 0.0009499924 ether; // 60000 share / (731 days * 24h * 60min * 60s)
        shareRewardPoolContractionRate = 0.0018999848 ether; // 2x
    ...
    function getDollarCirculatingSupply() public view returns (uint256) {
        ...
        for (uint8 entryId = 0; entryId < excludedFromTotalSupply.length; ++entryId) {
            balanceExcluded = balanceExcluded.add(dollarErc20.balanceOf(excludedFromTotalSupply[entryId]));
        }
