...
/**
 * @title Defi99's DErc20USDCDelegator Contract
 * @notice DTokens which wrap an EIP-20 underlying and delegate to an implementation
 */
contract DErc20USDCDelegator is DTokenInterface, DErc20Interface, DDelegatorInterface {
    /**
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "DErc20USDCDelegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"DErc20USDCDelegator:fallback: cannot send value to fallback");
