...
contract Torekko1155{
    bytes32 private constant implementationPosition =
        keccak256("implementation.contract.torreko1155:2022");
    bytes32 private constant proxyOwnerPosition =
        keccak256("owner.contract.torreko1155:2022");
    ...
    function setCollection(address /*_1155Collection*/) external onlyProxyOwner {
        _delegatecall();
    }
    ...
    function initPool(address /*_signatureUtils*/, address /*_1155 collection*/, address /*_rewardToken*/) external onlyProxyOwner {
        _delegatecall();
    }
    ...
    function emergencyWithdrawFromPool(address /*account_*/, string memory /* poolId_ */) external onlyProxyOwner{
        _delegatecall();
    }
