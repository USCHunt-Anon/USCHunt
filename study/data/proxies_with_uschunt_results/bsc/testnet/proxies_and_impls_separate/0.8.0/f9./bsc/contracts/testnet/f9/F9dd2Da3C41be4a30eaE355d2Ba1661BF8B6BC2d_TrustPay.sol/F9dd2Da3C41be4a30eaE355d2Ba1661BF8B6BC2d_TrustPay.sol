...
// File: contracts/pool/TrustPay.sol
...
contract TrustPay {
    bytes32 private constant implementationPosition =
        keccak256("implementation.contract.trustpay:2021");
    bytes32 private constant proxyOwnerPosition =
        keccak256("owner.contract.trustpay:2021");
    ...
    function setAdmin(address /*_address*/, bool /*value*/) external {
        _delegatecall();
    }

    function setSuperAdmin(address /*_address*/, bool /*value*/) external {
        _delegatecall();
    }
    ...
    function setTaxFee(uint256 /*_taxFee*/) external onlyProxyOwner {
         _delegatecall();
    }
    
    function setFeeRecipientAddress(address /*_feeRecipientAddress*/) external onlyProxyOwner {
         _delegatecall();
    }
