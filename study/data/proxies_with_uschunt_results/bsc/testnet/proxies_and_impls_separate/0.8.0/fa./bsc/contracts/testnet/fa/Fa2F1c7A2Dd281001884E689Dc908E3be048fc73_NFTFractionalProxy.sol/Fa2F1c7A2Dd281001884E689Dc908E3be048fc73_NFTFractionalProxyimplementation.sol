/** 
 *  SourceUnit: /Users/vuong/Documents/Ekoios/DA-NFT-Fractional/Contract/contracts/nft-fractional/NFTFractional.sol
*/
...
/**
 * note:
 * - Lien ket controller cua Token vs Fractional la single
 * - Cac ham trong ERC721 chi co controller duoc thuc hien
 */
contract NFTToken is ERC721 {
    ...
    */
    ...
    /**
     * @dev Transfers controller of the contract to a new account (`newController`).
     * @param _newController Address is new controller
    ...
    */
    ...
    /**
     * @dev Contract owner mint NFT
     * @param _receiver: wallet address to receive NFT after minted
     * @param _tokenId: token id of NFT
     * @param _data: meta data NFT
     * @return _tokenId
     */
    function minNFT(
        address _receiver,
    ...
    /**
     * @dev change name for NFT
     * @param _name new name for NFT
     */
    function setName(string memory _name) external onlyController {
        nameToken = _name;
    }

    /**
     * @dev change symbol for NFT
     * @param _symbol symbol name for NFT
     */
    function setSymbol(string memory _symbol) external onlyController {
        symbolToken = _symbol;
    }

    /**
     * @dev change base for nft
     * @param _url: Base URI for computing {tokenURI}
     */
    function setBaseURL(string memory _url) external onlyController {
        baseURI = _url;
    }
}
...
contract Upgradable {
    ...
    NFTToken public nftToken; // contract address of NFTToken
    address public controller;
...
contract NFTFractional is Upgradable {
    ...
    */
    ...
    function setNFTToken(address _nftToken) external onlyController {
        nftToken = NFTToken(_nftToken);
    }

    function minNFT(
        address _receiver,
        uint256 _tokenId) external onlyController {
        nftToken.minNFT(_receiver, _tokenId, "");
        emit MintNFT(_receiver, _tokenId, nftToken.nameToken(), nftToken.symbolToken(), "");
    }
