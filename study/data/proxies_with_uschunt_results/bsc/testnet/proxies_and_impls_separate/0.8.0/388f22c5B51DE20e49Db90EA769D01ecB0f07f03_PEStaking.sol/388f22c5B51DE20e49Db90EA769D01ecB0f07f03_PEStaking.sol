...
contract PEStaking {
    ...
    modifier onlyProxyOwner() {
        require(msg.sender == proxyOwner(),"PEStaking: Not the proxy owner");
        _;
    }
    ...
    function transferProxyOwnership(address _newOwner) public onlyProxyOwner {
        require(_newOwner != address(0), "PEStaking: Invalid new owner address");
    ...
    function upgradeTo(address _newImplementation) public onlyProxyOwner {
        ...
        require(currentImplementation != _newImplementation, "PEStaking: Invalid current implementation");
    ...
    function emercencyWithdrawToken(string memory /*_poolId*/, address /*_account*/, string memory /**_stakingId */) external onlyProxyOwner {
       _delegatecall();
    }
