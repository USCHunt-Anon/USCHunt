...
contract BlackColNew is Context, IBEP20, Ownable,Initializable {
    ...
    string private constant  _name = 'BLANEW';
    string private constant  _symbol = 'BLANEW';
    ...
    */
    ...
    _blackConfig.cLiquidityFee=1;
     numTokensSellToAddToLiquidity = 25 * 10**3 * 10**9;
