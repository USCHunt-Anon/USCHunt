...
contract SargonSale is Context, Initializable {
    ...
    address routerAddr;
    address public sargonAddr = 0x3a9808D2eB4A99106D7bB8e7e8CCDDAd006E026F;
    ...
    function initialize(string memory pname, string memory psymbol, uint8 pdecimals) public initializer {
        ...
        treasuryAddr = 0x94B833C84081a0eB2DDC27bCaEAB6a59Ce59Ab55;
        bankAddr = 0x2FCbaBd5AE30c0b7F7533e7A883fe8Ed37Acc146;
        buyFee = 15;
        liquidityFee = 2;
        treasuryFee = 5;
        slippageFee = 3;
    ...
    function buySargon(uint256 _amount) public {
        ...
        IBEP20(sargonAddr).buyToken(msg.sender, sargonAmount);
    }
    ...
    function sellSargon(uint256 _amount) public returns(bool){
        ...
        address pool =  0xb9Aae1AEB5bf8166fAB15E08e6F5c9eF6d6eBbf2;
