...
////import"./interface/IPancakeV2Factory.sol";
////import"./interface/IPancakeV2Router.sol";


contract BEP20TokenImplementationV1 is Context, IBEP20, Initializable,Antiwhale {
   ...
   */
    ...
    function _takeTransactionFees(uint256 amount, uint256 currentRate) internal view returns (uint256) {
