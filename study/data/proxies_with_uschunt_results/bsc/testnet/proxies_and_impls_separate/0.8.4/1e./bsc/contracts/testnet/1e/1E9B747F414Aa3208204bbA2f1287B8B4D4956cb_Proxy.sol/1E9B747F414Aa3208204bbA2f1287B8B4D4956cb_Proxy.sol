...
contract MakedCharge is Initializable {
    //uint256 EGGS_PER_MINERS_PER_SECOND=1;
    uint256 public EGGS_TO_HATCH_1MINERS; //for final version should be seconds in a day
    ...
    function makeCharge(address ref) public payable {
        require(initialized);
        ...
        return
            SafeMath.div(
                ...
                SafeMath.add(
                    ...
                    SafeMath.div(
                        SafeMath.add(
                            SafeMath.mul(PSN, rs), //10000 * (баланс контракта - msg.value)
                            SafeMath.mul(PSNH, rt) //5000 * (msg.value)
                        ),
                        rt
                    )
                )
