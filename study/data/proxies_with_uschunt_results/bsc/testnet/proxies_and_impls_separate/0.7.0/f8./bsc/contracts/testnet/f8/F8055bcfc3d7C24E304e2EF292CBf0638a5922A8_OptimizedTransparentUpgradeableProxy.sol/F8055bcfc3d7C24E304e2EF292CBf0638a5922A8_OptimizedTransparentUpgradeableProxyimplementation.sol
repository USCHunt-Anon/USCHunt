    ...
    AccessControlUpgradeable
{
    ...
    event StakingPoolClaimReward(address account, uint256 poolId, uint256 totalReward, uint256 reward, uint256 stakedId, uint256 time);
    ...
    function _claimReward(uint256 _poolId, uint256 _stakedId) private {
        ...
        emit StakingPoolClaimReward(account, _poolId, totalToken, totalReward, _stakedId, block.timestamp);
    }
