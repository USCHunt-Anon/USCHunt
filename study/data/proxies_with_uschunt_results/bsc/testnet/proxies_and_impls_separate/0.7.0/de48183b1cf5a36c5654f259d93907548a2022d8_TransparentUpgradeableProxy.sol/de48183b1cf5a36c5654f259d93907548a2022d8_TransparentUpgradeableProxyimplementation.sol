...
contract BEP20 is Context, IBEP20 {
    ...
    function initBEP20 (string memory name_, string memory symbol_, uint8 decimals_) internal{
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
    }
...
contract CBOX is BEP20, Initializable, Ownable {
    using SafeMath for uint256;
