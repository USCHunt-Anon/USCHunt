    ...
    ReentrancyGuard
{
    ...
    event UpgradeDigger(uint256 baseId, uint256 materialId, uint256 newLevel, uint256 newPower);
    ...
    // TODO: check sender is digger owner
    ...
    function upgrade(uint256 baseId, uint256 materialId) external nonReentrant {
        ...
        tokenDetails[baseId] = DiggerDetails.increasePower(tokenDetails[baseId]);
        _burn(materialId);
