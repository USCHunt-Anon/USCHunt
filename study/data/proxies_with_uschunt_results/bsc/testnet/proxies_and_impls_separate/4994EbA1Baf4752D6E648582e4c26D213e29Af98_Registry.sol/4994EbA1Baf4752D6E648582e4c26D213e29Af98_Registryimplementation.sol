...
contract Ownable {
    ...
    function setOwner(address newOwner) external _onlyOwner_ {
...
contract Registry is Storage, Ownable {
    ...
    function setLogic(address logic_) external _onlyOwner_ returns (bool) {
        logic = logic_;
        return true;
    }
    ...
    fallback () external {
        ...
        assembly {
            ...
            let res := delegatecall(gas(), target, ptr, calldatasize(), 0, 0)
