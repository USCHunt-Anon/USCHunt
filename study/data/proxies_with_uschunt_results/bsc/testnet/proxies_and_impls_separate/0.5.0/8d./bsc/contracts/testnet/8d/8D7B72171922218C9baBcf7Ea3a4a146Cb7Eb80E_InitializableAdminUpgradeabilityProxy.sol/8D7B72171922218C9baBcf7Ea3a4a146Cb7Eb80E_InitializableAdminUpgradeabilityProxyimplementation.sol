...
contract RewardPool is Ownable, Initializable {
    ...
    function resetCurrentCycle() public onlyOwner {
        cycles[currCycle]._cycleCollected = 0;
        cycles[currCycle]._currentTotalSupply = 0;
        cycles[currCycle]._cycleEndedTimeStamp = 0;
        cycles[currCycle]._isCycleActive = true;
    }
