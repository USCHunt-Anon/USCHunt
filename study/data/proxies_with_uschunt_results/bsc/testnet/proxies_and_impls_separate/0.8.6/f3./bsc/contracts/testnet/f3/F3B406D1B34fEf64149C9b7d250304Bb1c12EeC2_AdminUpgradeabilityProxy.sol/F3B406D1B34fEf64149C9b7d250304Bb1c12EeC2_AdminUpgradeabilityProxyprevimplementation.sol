...
contract PawnContract is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    returns (uint256 _idx)
    {
        ...
        // console.log("Number of Pawnshop packages: '%s'", numberPawnShopPackages);
        ...
        // console.log("Loan token: %s", newPackage.loanToken);
        ...
        // console.log("Reputation score %s", _reputation.getReputationScore(msg.sender));
    ...
    */
    ...
    ) external whenNotPaused onlyOperator
    {
        ...
        // Adjust reputation score
        _reputation.adjustReputationScore(msg.sender, IReputation.ReasonType.LD_GENERATE_CONTRACT);
    }
