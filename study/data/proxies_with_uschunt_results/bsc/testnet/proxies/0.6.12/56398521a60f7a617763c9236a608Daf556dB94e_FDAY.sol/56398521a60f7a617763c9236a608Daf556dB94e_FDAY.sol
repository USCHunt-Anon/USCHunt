...
contract FDAY is ApprovedEngine {
    constructor(
        address _game,
        address _sir
...
contract FDAYToken is ERC20, Ownable {
    uint8 private constant DECIMALS = 18;
    uint256 private constant INITIAL_TOTAL_SUPPLY = 7888 * (10**6) * (10 ** uint256(DECIMALS));
    ...
    function initialize() public initializer {
        ...
        ERC20.__ERC20_init("Fateful Day", "FDAY");
