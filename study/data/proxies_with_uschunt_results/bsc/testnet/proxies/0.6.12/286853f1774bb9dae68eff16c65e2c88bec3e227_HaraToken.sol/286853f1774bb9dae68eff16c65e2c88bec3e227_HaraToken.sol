...
contract Hara is ApprovedEngine {
    constructor(
        address _game,
        address _sir
...
// File: contracts/Hara.sol
pragma solidity 0.6.12;

contract HaraToken is ERC20, Ownable {
    uint8 private constant DECIMALS = 18;
    uint256 private constant INITIAL_TOTAL_SUPPLY = 800 * (10**10) * (10 ** uint256(DECIMALS));
    ...
    function initialize() public initializer {
        ...
        ERC20.__ERC20_init("Hara Token", "Hara");
