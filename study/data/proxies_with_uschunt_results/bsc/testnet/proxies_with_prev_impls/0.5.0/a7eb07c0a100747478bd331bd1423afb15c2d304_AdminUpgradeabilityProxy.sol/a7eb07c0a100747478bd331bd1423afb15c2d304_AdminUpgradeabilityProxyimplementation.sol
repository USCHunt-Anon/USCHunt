...
contract LockToken is Initializable, OwnableUpgradeSafe, PausableUpgradeSafe {
    ...
    */
    ...
    address payable public treasuryAddr = 0xBeBeb9a92502F60Aa1E850D8D439d894257B7350;
    address payable public stakingAddr = 0xBeBeb9a92502F60Aa1E850D8D439d894257B7350;
    uint256 public depositFee = 0.05 ether;
    uint256 public feeDividend = 400; // will divide by 1000 to get % value
    ...
    */
    ...
    returns (uint256 _id)
    {
        ...
        // transfer fee
        uint256 feeAmountToStaking = msg.value.mul(feeDividend).div(1000);
        stakingAddr.transfer(feeAmountToStaking);
        treasuryAddr.transfer(msg.value.sub(feeAmountToStaking));
    }
    ...
    */
    ...
    /*get fee config*/
    function getFeeConFig() view public returns (uint256 _depositFee, uint256 _feeDividend, address _treasuryAddr, address _stakingAddr)
    {
        return(depositFee, feeDividend, treasuryAddr, stakingAddr);
    }

    /*change treasury address*/
    function changeTreasuryAddress(address payable _treasuryAddr) onlyOwner public {
        treasuryAddr = _treasuryAddr;
    }

    /*change staking address*/
    function changeStakingAddress(address payable _stakingAddr) onlyOwner public {
        stakingAddr = _stakingAddr;
    }

    /*change fee dividend*/
    function changeFeeDividendAndFee(uint256 _feeDividend, uint256 _depositFee) onlyOwner public {
        require(_feeDividend <= 1000);
