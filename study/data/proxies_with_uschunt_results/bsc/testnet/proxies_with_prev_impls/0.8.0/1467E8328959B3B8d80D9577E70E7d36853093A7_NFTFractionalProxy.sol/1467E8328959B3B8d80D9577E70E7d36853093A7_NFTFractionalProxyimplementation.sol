/** 
 *  SourceUnit: /Users/vuong/Documents/Ekoios/DA-NFT-Fractional/Contract/contracts/NFTFractional.sol
*/
...
contract FractionalERC721 is ERC721 {
    ...
    */
    function _setBaseURL(string memory _url) internal {
        baseURI = _url;
    }
}
...
//////import"@openzeppelin/contracts/token/ERC721/ERC721.sol";
//////import"./FractionalERC721.sol";

contract Upgradable {
    mapping(address => bool) public adminList;
    FractionalERC721 public nftFraction;
...
contract NFTFractional is Upgradable {
    ...
    */
    ...
    function minNFT() external {
        emit MintNFT(address(0), 1,"FrNFT", "Fractional-NFT", "1");
    }
}