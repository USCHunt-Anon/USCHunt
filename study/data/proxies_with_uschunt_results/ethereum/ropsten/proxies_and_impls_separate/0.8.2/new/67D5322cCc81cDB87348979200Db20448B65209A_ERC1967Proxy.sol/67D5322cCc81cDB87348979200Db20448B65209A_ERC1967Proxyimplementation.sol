...
// token transfers
// ----------------------------------------------------------------------------
contract OnePlanetCarbonOffsetRootV6 is ERC20Interface, OwnableUpgradeable, UUPSUpgradeable {
	...
	address public MintableERC20PredicateProxy; // Polygon Bridge Address
    mapping(address => uint) balances;
    mapping(address => mapping(address => uint)) allowed;
    uint256 public retireMax;  // Make sure to set above zero on deployment
...
function initialize() public initializer {
        ...
        tetherAddress = payable(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa);
        usdcAddress = payable(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa);
    ...
    //-------------------------------------------------------------------------------------------------------
    // Enables approved marketplace to spend 1PLCO2 from a user's wallet that owns and approved the NFT sale
    //-------------------------------------------------------------------------------------------------------
    ...
    // In case oracle services is not available
    ...
    // ------------------------------------------------------------------------
    // Matic Mint Function for Root Contract
    // ------------------------------------------------------------------------
