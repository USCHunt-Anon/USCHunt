...
contract Token is Initializable, ContextUpgradeable, AccessControlUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, ERC20PermitUpgradeable {
    ...
    function initialize(address to) public virtual initializer {
        ...
        __Pausable_init_unchained();
        __ERC20Pausable_init_unchained();
        __ERC20Permit_init("XSToken");

        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(ADMIN_ROLE, _msgSender());

//        _mint(to, 100000000 * (10 ** 18));
        // uint256 amount = 258498693.019069996455928086;
