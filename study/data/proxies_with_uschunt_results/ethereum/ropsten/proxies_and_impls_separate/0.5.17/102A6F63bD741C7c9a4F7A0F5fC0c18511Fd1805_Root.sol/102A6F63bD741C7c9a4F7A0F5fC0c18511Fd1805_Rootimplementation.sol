...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 100; 
    uint256 private constant BOOTSTRAPPING_PRICE = 114e16; 

    /* Oracle */
    address private constant USDC = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    ...
    uint256 private constant EPOCH_START = 1609549545;
    uint256 private constant EPOCH_PERIOD = 3600;

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 96;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 40e18; 
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 96; // 36 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 42; // 12 epochs fluid
    ...
    uint256 private constant COUPON_REDEMPTION_PENALTY_DECAY = 3600; 

    /* Regulator */
    uint256 private constant SUPPLY_CHANGE_DIVISOR = 12e18; 
    uint256 private constant SUPPLY_CHANGE_LIMIT = 10e16; 
    uint256 private constant ORACLE_POOL_RATIO = 40; 
...
contract Getters is State {
    ...
    address private constant IMPLEMENTATION_CONTRACT = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);
