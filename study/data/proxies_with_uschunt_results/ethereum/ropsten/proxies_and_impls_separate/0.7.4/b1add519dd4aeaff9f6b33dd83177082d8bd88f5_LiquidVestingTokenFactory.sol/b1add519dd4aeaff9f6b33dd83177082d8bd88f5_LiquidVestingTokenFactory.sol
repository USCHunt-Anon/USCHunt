...
contract LiquidVestingTokenFactory is Ownable, ILiquidVestingTokenFactory {
    ...
    constructor(
        ...
        require(Address.isContract(_tokenImplementation), "Implementation is not a contract");
    ...
    function setMerkleRootSigner(address _newMerkleRootSigner) external override onlyOwner {
        merkleRootSigner = _newMerkleRootSigner;
    }

    function setFeeCollector(address _newFeeCollector) external override onlyOwner {
