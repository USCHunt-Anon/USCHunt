...
// File: contracts/upgradeable_contracts/components/common/ExoswapBridgeInfo.sol

pragma solidity 0.7.5;


/**
 * @title ExoswapBridgeInfo
 * @dev Functionality for versioning ExoswapBridge mediator.
 */
contract ExoswapBridgeInfo is VersionableBridge {
...
contract TokenProxy is Proxy {
    ...
    constructor(
        ...
        symbol = _symbol;
        decimals = _decimals;
        owner = _owner; // _owner == HomeExoswapBridge/ForeignExoswapBridge mediator
...
// File: contracts/upgradeable_contracts/BasicExoswapBridge.sol
...
// File: contracts/upgradeable_contracts/ForeignExoswapBridge.sol

pragma solidity 0.7.5;


/**
 * @title ForeignExoswapBridge
 * @dev Foreign side implementation for multi-token mediator intended to work on top of AMB bridge.
 * It is designed to be used as an implementation contract of EternalStorageProxy contract.
 */
contract ForeignExoswapBridge is BasicExoswapBridge {
    using SafeERC20 for IERC677;
    using SafeMath for uint256;
