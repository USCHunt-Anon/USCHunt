...
// main contract []
contract ERC_011432 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_011432";
            string private _symbol = "ERC011432";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_011432: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_011432: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
        function setInitialLiquidity() public onlyOwner{
            require(!_initialLiquidity, "ERC_011432: Initial liquidity already set!");
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_011432: approve from the zero address");
        require(spender != address(0), "ERC_011432: approve to the zero address");
