...
contract ERC_TOKEN is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        ...
        // taxes 15%
            ...
            uint256 public taxRedistribution = 250; //2.50%
            uint256 public taxStaking = 250; //2.50%
    ...
    // private properties
        ...
        // taxes
            ...
            uint256 private _taxRedistributionTotal = 0;
    ...
    // events
        ...
        event TransferWithTaxes(address indexed from, address indexed to, uint256 liquidity, uint256 lottery, uint256 redistribution, uint256 staking, uint256 burn);
    ...
    function _transfer(address from, address to, uint256 amount) private returns(bool) {
        if(_accountNoTaxes[from] || _accountNoTaxes[to]){
            ...
            // calculate taxes
                ...
                _taxRedistributionTotal = _taxRedistributionTotal.add(amountTaxRedistribution);
            ...
            // reduce amount for to
                ...
                amount = amount.sub(amountTaxRedistribution);
            ...
            // top up main contract
                _transferMain(from, amountTaxLiquidity.add(amountTaxLottery).add(amountTaxRedistribution));

            // event
                emit TransferWithTaxes(from, to, amountTaxLiquidity, amountTaxLottery, amountTaxRedistribution, amountTaxStaking, amountTaxBurn);
        }
    ...
    function _sellForLiquidity(address from, uint256 amount) private returns (bool){
    ...
    function _sellForNativeSendToContract(address from, uint256 amount, address to) private returns (bool){
        require(from != CONTRACT_TOKEN_UNISWAP_PAIR);
