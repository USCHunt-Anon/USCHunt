...
// main contract []
contract ERC_TOKEN_301727 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_TOKEN_301727";
            string private _symbol = "ERC301727";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_TOKEN_301727 decreased allowance below zero"));
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_TOKEN_301727 transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_TOKEN_301727 approve from the zero address");
        require(spender != address(0), "ERC_TOKEN_301727 approve to the zero address");
    ...
    function _tax(uint256 amount, uint256 tax) private view returns (uint256){
        return(amount.mul(tax).div(10**4));
    }
}