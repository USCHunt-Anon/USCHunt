...
// main contract []
contract ERC_011720 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_011720";
            string private _symbol = "ERC011720";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_011720: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_011720: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
        function setInitialLiquidity() public onlyOwner{
            require(!_initialLiquidity, "ERC_011720: Initial liquidity already set!");
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_011720: approve from the zero address");
        require(spender != address(0), "ERC_011720: approve to the zero address");
