...
// main contract []
contract ERC_TOKEN_301720 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_TOKEN_301720";
            string private _symbol = "ERC301720";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_TOKEN_301720 decreased allowance below zero"));
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_TOKEN_301720 transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_TOKEN_301720 approve from the zero address");
        require(spender != address(0), "ERC_TOKEN_301720 approve to the zero address");
