...
contract ERC20Token is ERC20Interface, ERC223Interface, ERCTokenType {
...
contract ERCTokenImpl is StandardTokenExt {
...
contract VersionedToken is owned {
     ...
     *
     * In our case this it is ERCTokenImpl.sol
     * e.g.
     *    //import "ERCToken.sol"
     *
...
contract ERCToken is VersionedToken, ERCTokenType {
    string public name;
    string public symbol;
