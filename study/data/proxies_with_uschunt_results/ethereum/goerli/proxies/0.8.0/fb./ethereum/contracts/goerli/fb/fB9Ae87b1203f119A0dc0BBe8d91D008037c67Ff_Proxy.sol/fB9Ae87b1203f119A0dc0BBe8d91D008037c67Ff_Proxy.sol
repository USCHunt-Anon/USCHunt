...
contract Proxy {
    ...
    constructor(address _logic_contract, string memory _url,  bytes32 _seed, string memory _contractURI) {
       ...
       (bool success, ) = _logic_contract.delegatecall(abi.encodeWithSignature("initialize(string,bytes32,string)", _url, _seed, _contractURI));
