...
contract NFTFactory is ERC1155Upgradeable, AccessControlUpgradeable, IERC2981, IMintableERC1155  {
    ...
    */
    function mint(address account, uint256 id, uint256 amount, bytes calldata data)  external virtual override onlyRole(PREDICATE_ROLE) {
        _mint(account, id, amount, data);
    }

    function mintBatch(address to, uint256[] calldata ids, uint256[] calldata amounts, bytes calldata data)  external virtual override onlyRole(PREDICATE_ROLE) {
