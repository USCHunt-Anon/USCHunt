    ...
    StakeManagerStorageExtension
{
    ...
    function getStakeNonce() public view returns (uint256) {
        return stakeNonce;
    }
    ...
    function validatorJoin(
        ...
        // uint256 stakeNonce = logger.validatorNonceAdd(validatorId, 1);
        ...
        logger.logStakeAck(validatorId, stakeNonce);
    }
    ...
    function stakeUpdate(
        ...
        uint256 oldAmount = validators[validatorId].amount;
        validators[validatorId].amount = newAmount;

        updateTimeline(int256(newAmount - oldAmount), 0, 0);
