...
contract TestERC20 is ERC20 {
    address public constant PATCH_ADDRESS = 0xb3F1F067173862D7067Fc13431911CC568387E17;
    ...
    /**
     * @dev Fallback function that delegates calls to the address PATCH_ADDRESS. Will run if no other
    ...
    fallback () external payable virtual {
       // solhint-disable-next-line no-inline-assembly
        assembly {
            ...
            let result := delegatecall(gas(), PATCH_ADDRESS, 0, calldatasize(), 0, 0)
