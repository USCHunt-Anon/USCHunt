...
contract BaseImplementation is IWallet {
     using ECDSA for bytes32;

    address public override owner;
    uint256 public nonce; //change to 2D nonce
     ...
     */
    modifier onlyOwner {
        require(msg.sender == owner, "BW: sender not authorized");
        _;
    }
