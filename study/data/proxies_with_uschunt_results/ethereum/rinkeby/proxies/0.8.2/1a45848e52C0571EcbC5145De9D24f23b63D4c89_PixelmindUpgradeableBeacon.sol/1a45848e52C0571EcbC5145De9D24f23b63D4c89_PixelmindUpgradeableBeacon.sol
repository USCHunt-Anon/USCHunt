...
// File: SeriesMintingUpgradeableBeacon.sol
...
contract PixelmindUpgradeableBeacon is UpgradeableBeacon {
    address[] private series;

    constructor(address _implementation) UpgradeableBeacon(_implementation) {}

    function newSeries(string calldata baseURI) public {
        bytes memory data = abi.encodeWithSignature("initialize(string)", baseURI);
        BeaconProxy seriesBeaconProxy = new BeaconProxy(address(this), data);
