// hevm: flattened sources of contracts/DebtLockerFactory.sol
...
contract MapleProxyFactory is IMapleProxyFactory, ProxyFactory {
    ...
    constructor(address mapleGlobals_) {
        require(IMapleGlobalsLike_3(mapleGlobals = mapleGlobals_).governor() != address(0), "MPF:C:INVALID_GLOBALS");
    }

    modifier onlyGovernor() {
        require(msg.sender == IMapleGlobalsLike_3(mapleGlobals).governor(), "MPF:NOT_GOVERNOR");
        _;
    }
    ...
    function setGlobals(address mapleGlobals_) public override virtual onlyGovernor {
        require(IMapleGlobalsLike_3(mapleGlobals_).governor() != address(0), "MPF:SG:INVALID_GLOBALS");
