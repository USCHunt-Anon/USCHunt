// hevm: flattened sources of contracts/MapleLoanFactory.sol
// ////-License-Identifier: AGPL-3.0-or-later AND AGPL-3.0-only
...
////// contracts/interfaces/IMapleLoanFactory.sol
/* pragma solidity 0.8.7; */
...
////// modules/maple-proxy-factory/contracts/interfaces/Interfaces.sol
/* pragma solidity 0.8.7; */
...
////// modules/maple-proxy-factory/modules/proxy-factory/contracts/Proxy.sol
/* pragma solidity ^0.8.7; */
...
////// modules/maple-proxy-factory/modules/proxy-factory/contracts/ProxyFactory.sol
/* pragma solidity ^0.8.7; */
...
////// modules/maple-proxy-factory/contracts/MapleProxyFactory.sol
/* pragma solidity 0.8.7; */
...
contract MapleProxyFactory is IMapleProxyFactory, ProxyFactory {
    ...
    constructor(address mapleGlobals_) {
        require(IMapleGlobalsLike_2(mapleGlobals = mapleGlobals_).governor() != address(0), "MPF:C:INVALID_GLOBALS");
    }

    modifier onlyGovernor() {
        require(msg.sender == IMapleGlobalsLike_2(mapleGlobals).governor(), "MPF:NOT_GOVERNOR");
        _;
    }
    ...
    function setGlobals(address mapleGlobals_) public override virtual onlyGovernor {
        require(IMapleGlobalsLike_2(mapleGlobals_).governor() != address(0), "MPF:SG:INVALID_GLOBALS");
...
////// contracts/MapleLoanFactory.sol
/* pragma solidity 0.8.7; */
