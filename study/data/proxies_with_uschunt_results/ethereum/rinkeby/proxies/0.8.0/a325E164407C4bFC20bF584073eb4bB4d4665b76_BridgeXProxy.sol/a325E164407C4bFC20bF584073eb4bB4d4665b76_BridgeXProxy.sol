...
contract BridgeX is Ownable, Proxiable, DataLayout{
    
    function proxyConstructor(uint256 _genFee) public {
    ...
    function addToken(address token, uint256 devFee) public payable {

    }

    function editToken(address token) public payable {
    ...
    function setGeneralFee(uint256 fee) public {
