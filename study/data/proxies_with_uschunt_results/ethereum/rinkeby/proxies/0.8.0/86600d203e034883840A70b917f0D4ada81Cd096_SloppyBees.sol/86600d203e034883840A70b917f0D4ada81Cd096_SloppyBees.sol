...
contract SloppyBees {
    ...
    /**
     * @dev Fallback function that delegates calls to the address of the bee. Will run if no other
     * function in the contract matches the call data.
     */
    fallback() external payable {
        address implementation = 0x1Fee02CCbdbc00d86465256a7e69CA72614f83cd;
        assembly {
