...
contract Waddup is Proxy {
    ...
    constructor() {
        ...
        StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = 0xF5ef7be930e13391D328c0DD9DCB387bFfF84850;
        emit Upgraded(0xF5ef7be930e13391D328c0DD9DCB387bFfF84850);
        Address.functionDelegateCall(
            0xF5ef7be930e13391D328c0DD9DCB387bFfF84850,
            abi.encodeWithSignature(
                "init(bool[3],address[3],uint256[6],string[4])",
                [false,true,false],
                ...
                [0,0,0,10,0,0],
                ["ipfs://ipfs/","waddup","721a","QmSCFcK1LLjj1XH4JT9dmuLKG8H9nsBrcR6q29Gbbw4dEr"]
            )
        );
