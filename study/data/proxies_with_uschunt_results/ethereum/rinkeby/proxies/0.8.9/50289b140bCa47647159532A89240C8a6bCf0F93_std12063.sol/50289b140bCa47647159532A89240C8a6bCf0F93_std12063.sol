...
contract ERC721StandardCollection is ERC721Marketplace {   
     ...
     */
    constructor(
        bool[1] memory bools, address[4] memory addresses, uint256[4] memory uints, string[2] memory strings
    ...
    function _init(
        ...
        payoutContractAddress = addresses[3];//0xc495c35C7220D93aA3CA77E8D394bdf7241257d6; 
    ...
    function buyNewToken(
        ...
        IEaselyPayout(payoutContractAddress).splitPayable{ value: currentPrice }(owner(), revenueShare, revenueShareBPS);
        payable(_msgSender()).transfer(msg.value - currentPrice);
    }
