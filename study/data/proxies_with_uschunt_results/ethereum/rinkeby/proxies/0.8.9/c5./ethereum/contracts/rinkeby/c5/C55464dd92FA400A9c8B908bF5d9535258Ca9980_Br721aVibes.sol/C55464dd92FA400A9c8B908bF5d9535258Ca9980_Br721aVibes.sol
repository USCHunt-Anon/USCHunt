...
contract Br721aVibes is Proxy {
    ...
    constructor() {
        ...
        StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = 0x36FD9c81814b4A44201E0D9ab9B8174Dc798250e;
        emit Upgraded(0x36FD9c81814b4A44201E0D9ab9B8174Dc798250e);
        Address.functionDelegateCall(
            0x36FD9c81814b4A44201E0D9ab9B8174Dc798250e,
            abi.encodeWithSignature(
                "init(bool[3],address[4],uint256[9],string[4],bytes[2])",
                [false,true,false],
                ...
                [500,0,0,0,0,0,15,0,0],
                ["ipfs://","br721a vibes","A","QmexveurKBCfb5hzV4XTVAtf9z5gnwY8dRrxBMUqeVmxFm"],
								["",""]
            )
        );
