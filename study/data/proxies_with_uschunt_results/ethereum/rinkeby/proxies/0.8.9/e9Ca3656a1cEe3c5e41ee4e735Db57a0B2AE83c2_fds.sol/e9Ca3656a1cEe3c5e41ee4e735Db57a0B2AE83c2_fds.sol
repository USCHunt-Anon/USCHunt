...
contract fds is Proxy {
    ...
    constructor() {
        ...
        StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = 0x5498979e1808256cAB3E533b88d1926DaAd23bf5;
        emit Upgraded(0x5498979e1808256cAB3E533b88d1926DaAd23bf5);
        Address.functionDelegateCall(
            0x5498979e1808256cAB3E533b88d1926DaAd23bf5,
            abi.encodeWithSignature(
                "init(bool[1],address[3],uint256[3],string[2])",
                [false],
                [0xd5A699DBa4FB672AD855D201B85564b44695513c,0x0000000000000000000000000000000000000000,0x1BAAd9BFa20Eb279d2E3f3e859e3ae9ddE666c52],
                [0,1000,0],
                ["fds","fdss"]
            )
        );
