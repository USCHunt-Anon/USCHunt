...
contract Test is Proxy {
    ...
    constructor() {
        ...
        StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = 0x65e86278655ae5ad2f304C61A3D7dA119D78D846;
        emit Upgraded(0x65e86278655ae5ad2f304C61A3D7dA119D78D846);
        Address.functionDelegateCall(
            0x65e86278655ae5ad2f304C61A3D7dA119D78D846,
            abi.encodeWithSignature(
                "init(bool[3],address[3],uint256[6],string[3])",
                [false,true,false],
                ...
                [0,0,0,10,0,0],
                ["test","t","QmcsCF7x4z1Dpnu8ZMmv7p4Mo4swVpai3C7Rva5J6K8mWY"]
            )
        );
