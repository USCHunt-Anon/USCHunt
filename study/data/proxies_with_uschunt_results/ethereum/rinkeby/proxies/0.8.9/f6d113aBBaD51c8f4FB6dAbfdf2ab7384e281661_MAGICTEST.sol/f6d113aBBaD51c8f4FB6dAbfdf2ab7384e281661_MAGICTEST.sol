...
contract MAGICTEST is Proxy {
    ...
    constructor() {
        ...
        Address.functionDelegateCall(
            ...
            abi.encodeWithSignature(
                ...
                [false,true],
                [0x8fbEFC1eeA93e936275ce763E43Ed47E87f09E0C,0x0000000000000000000000000000000000000000,0x0000000000000000000000000000000000000000,0x1BAAd9BFa20Eb279d2E3f3e859e3ae9ddE666c52],
                [500,200,500,0,0,1000,3,3],
                ["MAGICTEST","MGC","QmRTNNRs4wDLe8VHftUesvPcFGkmJvA4V55n7f842zzd7G"],
                ["",""]
            )
        );
    ...
    function upgradeTo(
        ...
        require(msg.sender == 0xAB9A2638D7E63Ed0b3Fad22b88b8a2412Bb1bDB1);
