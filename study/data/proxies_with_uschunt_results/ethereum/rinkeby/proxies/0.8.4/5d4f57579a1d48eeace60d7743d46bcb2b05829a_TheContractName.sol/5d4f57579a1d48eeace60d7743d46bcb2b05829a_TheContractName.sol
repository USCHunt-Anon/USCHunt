...
// File contracts/4/ERC721ContractWrapper.sol
...
contract ERC721ContractWrapper is Proxy {
    address internal constant _IMPLEMENTATION_ADDRESS = 0x6c76eD1038f9d43935b7EC69eE6FdB9acF8ba45A;
    bytes32 internal constant _IMPLEMENTATION_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;
...
// File contracts/TheContractName.sol

pragma solidity ^0.8.4;

contract TheContractName is ERC721ContractWrapper {
  constructor() ERC721ContractWrapper("ipfs://bafybeielyuwmdqa7vjpsybcqgr4pyc2xari7e5nclmq2ink3y7wafzmq5m/", "No Name","MTC",150) {}
}
  ...
  OwnableUpgradeable
{
  ...
  uint256 private _spread = 0.15 ether;
  uint256 private _commission = 45;
