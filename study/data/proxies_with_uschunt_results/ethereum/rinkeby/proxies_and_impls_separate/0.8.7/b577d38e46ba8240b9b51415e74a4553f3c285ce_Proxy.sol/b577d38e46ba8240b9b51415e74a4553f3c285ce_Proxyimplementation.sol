// hevm: flattened sources of contracts/MapleLoan.sol
// : AGPL-3.0-or-later AND AGPL-3.0-only
...
////// contracts/MapleLoanInternals.sol
/* pragma solidity 0.8.7; */
...
abstract contract MapleLoanInternals is MapleProxiedInternals {
    ...
    function _fundLoan(address lender_) internal returns (uint256 fundsLent_) {
        ...
        IMapleGlobalsLike_1 globals = IMapleGlobalsLike_1(IMapleLoanFactory(_factory()).mapleGlobals());
...
contract MapleLoan is IMapleLoan, MapleLoanInternals {
    ...
    function isProtocolPaused() public view override returns (bool paused_) {
        return IMapleGlobalsLike_1(IMapleProxyFactory(_factory()).mapleGlobals()).protocolPaused();
    }
