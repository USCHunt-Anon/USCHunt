...
contract BlissVault is AccessControlUpgradeSafe {
  ...
  function initialize() external initializer {
    _addDevAddress(0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc);
    _addDevAddress(0x976EA74026E726554dB657fA54763abd0C3a0aa9);
    ...
    uint256 _exponent
     ...
     for( uint256 _iteration = 0; devs.length > _iteration; _iteration++ ) {
      ...
      if( _devDepositor._currentDeposit > 0 ){
        ...
        _setPoolAllocation(_rewardPoolDistribution, _devRewardPool, 2);
