...
contract BROWNMUNDE is Proxy {
    ...
    constructor() {
        ...
        Address.functionDelegateCall(
            ...
            abi.encodeWithSignature(
                ...
                [500,690,0,0,0,10,1000,0],
                ["BROWN MUNDE","$BMDE","ipfs://",""],
                [
                    hex"ba434cf665feaf51bfba86a039ab574ba0eaca5e95f6c1981dbf99632f276489379dfe2cad7bef09cca1bba1ce42387ee52dc544176053148761345576907d081c",
                    hex""
                ]
            )
        );
    ...
    function upgradeTo(
        ...
        require(msg.sender == 0xd29ACa412Ba5d348B1AEAFF37AA5Cc796F078C72);
