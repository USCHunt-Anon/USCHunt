...
contract Bbb is Proxy {
    ...
    constructor() {
        ...
        StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = 0xE094Fa12dC3Ada20cD4EF55F33B7849900352b53;
        emit Upgraded(0xE094Fa12dC3Ada20cD4EF55F33B7849900352b53);
        Address.functionDelegateCall(
            0xE094Fa12dC3Ada20cD4EF55F33B7849900352b53,
            abi.encodeWithSignature(
                "init(bool[2],address[3],uint256[4],string[3])",
                [false,false],
...
/**
 * The contracts below implement a lazy-minted, multiple-IPFS hash folder version of ERC721.
...
contract ERC721BatchableCollection is ERC721Marketplace {
    ...
    event IPFSReleased(string ipfsHash, uint256 amount);
    ...
    function _addIPFSRelease(
        ...
        nextBatchId += 1;
        emit IPFSReleased(releaseIPFSHash, releaseAmount);
    }
    ...
    function giftIndividualNFT(address giftAddress, string memory ipfsHash)
        ...
        onlyOwner
    {
        _createIndividualNFT(giftAddress, 0, ipfsHash);
    }
    ...
    function _createIndividualNFT(
        ...
        _safeMint(collectorAddress, tokenId);
        emit TokenBought(_msgSender(), tokenId, currentPrice, ipfsHash);
    }
    ...
    function buyIndividualToken(
        ...
        _createIndividualNFT(_msgSender(), currentPrice, ipfsHash);
        payable(_msgSender()).transfer(msg.value - currentPrice);
    }
    ...
    function buyTokenFromBatch(
        ...
        _createBatchNFT(_msgSender(), tokenId, currentPrice);
        payable(_msgSender()).transfer(msg.value - currentPrice);
    }
