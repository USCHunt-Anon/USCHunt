...
contract Batchable is Proxy {
    ...
    constructor() {
        ...
        StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = 0xF4262819f1a11fc94bdEbDb6Ea76338Bd284afe2;
        emit Upgraded(0xF4262819f1a11fc94bdEbDb6Ea76338Bd284afe2);
        Address.functionDelegateCall(
            0xF4262819f1a11fc94bdEbDb6Ea76338Bd284afe2,
            abi.encodeWithSignature(
                "init(bool[2],address[3],uint256[4],string[4])",
                [false,false],
                [0xb8C4AA83A99ef22a0930b7FcA48dbfeCD20B5810,0x0000000000000000000000000000000000000000,0x1BAAd9BFa20Eb279d2E3f3e859e3ae9ddE666c52],
                [0,100,0,0],
                ["ipfs://ipfs/","batchable","batch",""]
            )
        );
