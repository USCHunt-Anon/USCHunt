...
// Dependency file: contracts/Interface/ILayer.sol
...
interface ILayer is IERC721Upgradeable {
    function __Layer_init(string memory name, string memory symbol) external;
...
// Dependency file: contracts/Interface/IModule.sol
...
// Dependency file: contracts/Storage/Layer_storage_v0.sol
...
contract LayerStorageV0 {
    struct Layer {
        // true when layer exists, false otherwise
        bool exists;
...
// Root file: contracts/Layer/Layer.sol
...
// //import"@openzeppelin/contracts-upgradeable/token/ERC721/extensions/IERC721MetadataUpgradeable.sol";
// //import"contracts/Interface/ILayer.sol";
// //import"contracts/Interface/IModule.sol";
// //import"contracts/Storage/Layer_storage_v0.sol";

contract StatefulLayer is ILayer, ERC721Upgradeable, LayerStorageV0 {
    using AddressUpgradeable for address;

    function __Layer_init(string memory name_, string memory symbol_)
        public
        override
        initializer
    {
    ...
    function getLayer(uint256 id)
        ...
        returns (uint32 maxState, uint32 currencyState)
    {
        require(layers[id].exists, "token not exist");
    ...
    function mintStateLayer(
        ...
        require(!layers[id].exists, "token already existed");

        layers[id] = Layer(true, false, maxState, currentState, address(0));
    ...
    function mintModuleLayer(
        ...
        layers[id] = Layer(true, true, 0, 0, module);
        _safeMint(to, id, _data);
    }
