...
// File: TestCompensationPlan.sol

contract TestCompensationPlan is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    external nonReentrant whenNotPaused enough(_amountAllowedToClaim)
    {
        ...
        IERC20Upgradeable(vAkro).transfer(_msgSender(), availableAmount);
