 ...
 * contract: @isiain
 */
contract OtisNFTContract is OwnableUpgradeable, ERC721Upgradeable, IERC2981Upgradeable {
    ...
    modifier onlyAllowedMinter() {
        require(allowedMinters[msg.sender], "Minter not allowed");
        _;
    }
    ...
    function setAllowedMinter(address to, bool canMint) external {
