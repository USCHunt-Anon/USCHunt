...
// File: contracts/Staking/UpgradeabilityProxy.sol
...
contract UpgradeabilityProxy {
    ...
    uint public constant timelockPeriod = 600; // 10 minutes
    ...
    function setNewImplementation(address _newImplementation) public {
        ...
        uint newTimelock = timelock().add(timelockPeriod);
        _setTimelock(newTimelock);
    }

    function transferImplementation(bytes memory initializationData, bool forceCall) public {
        require(msg.sender == proxyOwner(), "UpgradeabilityProxy: only owner can transfer implementation.");
