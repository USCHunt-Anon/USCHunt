...
contract OCCStakingImp is Ownable, ReentrancyGuard {
    ...
    function initialize(address _OCC, uint _unstakingFeeRatio, address _assetManager, address _owner, uint emissionStart, uint firstCheckPoint, uint _rewardPerSecond) public {
    ...
    function setNewUnstakingFeeRatio(uint _newUnstakingFeeRatio) public onlyOwner {
        ...
        unstakingFeeRatioTimelock = unstakingFeeRatioTimelock.add(unstakingFeeRatioTimelockPeriod);
    }
