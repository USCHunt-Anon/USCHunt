...
// Dependency file: contracts/InfluencerStorageV0/Influencer_storage_v0.sol
...
contract InfluencerStorageV0 {
    ...
    /**
     * @dev tracks latest token ID
     */
    uint256 public latestTokenID;
}


// Dependency file: contracts/Influencer/IInfluencer.sol
...
// Root file: contracts/InfluencerV0/Influencer_v0.sol
...
// //import"contracts/InfluencerStorageV0/Influencer_storage_v0.sol";
// //import"contracts/Influencer/IInfluencer.sol";
    ...
    AccessControlUpgradeable
{
     ...
     * @dev Mints new token for `amount` quantity and transfers it to `to`.
     */
    function mint(address to, uint256 amount) public override onlyManager {
        _mint(to, latestTokenID, amount, "");
        latestTokenID = latestTokenID.add(1);
    }
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < count; i++) {
            ids[i] = latestTokenID + i;
            amounts[i] = amount;
        }
        _mintBatch(to, ids, amounts, "");
        latestTokenID = latestTokenID.add(count);
    }
