...
contract SecretMoneySociety is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public currentPrice = 10000000000; // 0.1 ether
    ...
    function mintWhitelist(
        ...
        require(whitelistMintPerWallet[msg.sender] < maxWhitelistMintPerWallet, "mint: too many already minted");
        require(quantity > 0, "mint: minimum 1");
    ...
    function gift(
        ...
        for(uint256 i; i < quantity; i++){
            _safeMint(_wallet, totalSupply + i);
            totalSupply += 1;
        }
    }
