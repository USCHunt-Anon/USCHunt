...
interface IMarketDistributor {

    function name() external view returns (string memory);

    function setMaxOffset(uint256 _offset) external;
...
contract MarketDistributor is OwnableUpgradeable, IMarketDistributor {

    string public _symbol = "TM";
    uint256 public MAX_OFFSET = 18;

    function initialize(string calldata symbol_) public initializer {
        _symbol = symbol_;
    }
    ...
    function setMaxOffset(uint256 _offset) public override {
        MAX_OFFSET = _offset;
    }
}