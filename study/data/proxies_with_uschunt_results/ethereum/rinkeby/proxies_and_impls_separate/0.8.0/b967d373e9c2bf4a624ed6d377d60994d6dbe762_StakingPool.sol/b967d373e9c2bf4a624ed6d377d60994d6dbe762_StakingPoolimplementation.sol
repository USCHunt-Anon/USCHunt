...
contract ImplAndTermsV2 is Storage, Ownable, ERC20Init {
    ...
    function initialize(
        ...
        holdTimeRefMin = 30 days;
        holdTimeMax = 1095 days;
    ...
    function stakeInternal(address staker, uint tokenAmount, uint holdTime, address referer, address influencer, bool donatsForDevelopers) internal {
        ...
        require(holdTime <= holdTimeMax, "ImplAndTerms::stakeInternal: hold time must be less than 3 years");
        ...
        if (referer != address(0)) {
            require(holdTime >= holdTimeRefMin, "ImplAndTerms::stakeInternal: holdtime with referer must be more than 30 days");
