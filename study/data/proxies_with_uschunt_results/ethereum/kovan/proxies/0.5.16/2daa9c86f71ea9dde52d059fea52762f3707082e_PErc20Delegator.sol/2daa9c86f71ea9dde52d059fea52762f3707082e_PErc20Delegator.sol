...
contract PErc20Delegator is PTokenInterface, PErc20Interface, PDelegatorInterface {
    ...
    {
        bytes memory data = delegateToViewImplementation(abi.encodeWithSignature("getAccountSnapshot(address,bool)", account, isCreditLoan));
    ...
    //信用贷相关
    function setWhiteList(address trustList) public returns (uint256) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("setWhiteList(address)", trustList));
        return abi.decode(data, (uint256));
    }
    ...
    function doCreditLoanBorrow(
        ...
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("doCreditLoanBorrow(address,address,uint256)", _trust, _borrower, _borrowAmount));
        return abi.decode(data, (uint256));
    }
    ...
    function doCreditLoanRepay(
        ...
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("doCreditLoanRepay(address,address,uint256)", _trust, _payer, _repayAmount));
