...
contract PErc20Delegator is PTokenInterface, PErc20Interface, PDelegatorInterface, ICreditLoan {
    ...
    {
        bytes memory data = delegateToViewImplementation(abi.encodeWithSignature("getAccountSnapshot(address,uint8)", account, loanType));
     ...
     */
    function borrowBalanceCurrent(address account, LoanType loanType) external returns (uint256) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("borrowBalanceCurrent(address,uint8)", account, loanType));
        return abi.decode(data, (uint256));
    }
     ...
     */
    function borrowBalanceStored(address account, LoanType loanType) public view returns (uint256) {
        bytes memory data = delegateToViewImplementation(abi.encodeWithSignature("borrowBalanceStored(address,uint8)", account, loanType));
        return abi.decode(data, (uint256));
    }
    ...
    function doCreditLoanBorrow(
        ...
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("doCreditLoanBorrow(address,uint256,uint8)", _borrower, _borrowAmount, _loanType));
        return abi.decode(data, (uint256));
    }
    ...
    function doCreditLoanRepay(
        ...
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("doCreditLoanRepay(address,uint256,uint8)", _payer, _repayAmount, _loanType));
        return abi.decode(data, (uint256, uint256));
    }
}