...
function getUserDetails(address _user, string memory _key1, string memory _key2) public view returns (string memory){
    return users[_user].details[_key1][_key2];
}
function getuserIntDetails(address _user, string memory _key) public view returns (uint){
    return users[_user].IntValues[_key];
}
function getAddressDetails(address _user, string memory _key) public view returns (address){
    return users[_user].addresses[_key];
}
function getByteDetails(address _user, string memory _key) public view returns (bytes memory){
    return users[_user].byteValue[_key];
}

function getBoolDetails(address _user, string memory _key) public view returns (bool){
    return users[_user].boolValues[_key];
}
