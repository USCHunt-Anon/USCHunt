...
//////-License-Identifier: lgplv3 OR MIT
    ...
    ERC1155TokenReceiver
{
    ...
    function eipFeatures() public pure returns (uint256[4] memory fs) {
        fs = [uint256(165), uint256(721), uint256(1155), uint256(777)];
    }
