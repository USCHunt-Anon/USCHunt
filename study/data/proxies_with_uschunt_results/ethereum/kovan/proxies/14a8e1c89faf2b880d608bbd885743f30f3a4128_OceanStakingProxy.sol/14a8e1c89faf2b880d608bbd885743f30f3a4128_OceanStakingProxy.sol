...
// File contracts/OceanStakingProxy.sol

pragma solidity >=0.8.0<0.9.0;


contract OceanStakingProxy is TransparentUpgradeableProxy, Context {
    modifier onlyAdmin {
        require(_msgSender() == _getAdmin(), "OceanStakingProxy: Only admin can call this");
        _;
    }
