...
// File: @openzeppelin/contracts-upgradeable@4.3.2/security/PausableUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.3.2/token/ERC20/IERC20Upgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.3.2/token/ERC20/extensions/IERC20MetadataUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.3.2/token/ERC20/ERC20Upgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.3.2/token/ERC20/extensions/ERC20PausableUpgradeable.sol
...
// File: Volumes/code/remix/my/new_cow/NewCowCoin.sol
...
contract NewCowCoin is ERC20PausableUpgradeable,OwnableUpgradeable {
    address public feeAddress;
    
    using MathX128 for uint;
    
    function init(string calldata name_, string calldata symbol_,address _feeAddress,address to,uint cap) public initializer {
        __Ownable_init();
    ...
    function _fee(uint amount) internal virtual returns(uint fee) {
        return amount/20;
    }
}