...
// File @openzeppelin/contracts-upgradeable/utils/cryptography/MerkleProofUpgradeable.sol@v4.1.0
...
// File contracts/Loggers/ILogger.sol
...
// File contracts/vesting/FixedPoolLinearVesting.sol
    ...
    IVesting
{
    ...
    function startVesting(
        ...
        _merkleRoot = whitelistedUsersMerkleRoot;
    ...
    function isEligible(address user, bytes32[] memory merkleProof)
        public
        view
        returns (bool)
    {
        ...
        whitelistedMembersOnly(user, merkleProof)
    {
        ...
        //Emit event.
        _logger.emitVestingFirstClaim(address(_token), address(this), user, claimableTokens);
    }
...
// File contracts/IDOPool/IFixedPool.sol
...
interface IFixedPool {
    ...
    function setLogger(ILogger logger_) external;
}


// File contracts/PowerController/IPowerController.sol


pragma solidity ^0.8.0;

abstract contract IPowerController {
    function increasePower(address user, uint256 power) external virtual;

    function decreasePower(address user, uint256 power) external virtual;
...
// File contracts/Proxy/IBeacon.sol
...
// File contracts/Proxy/BeaconProxy.sol
...
// File contracts/IDOController/IDOController.sol
...
contract IDOController is Initializable, AccessControlUpgradeable {
    ...
    function startIDO(
        ...
        IFixedPool(address(IDOProxy)).setLogger(_logger);
    ...
    function revokeIDO(uint256 idoIndex) external onlyRole(DEFAULT_ADMIN_ROLE) {
        IDO storage ido = _idos[idoIndex];
