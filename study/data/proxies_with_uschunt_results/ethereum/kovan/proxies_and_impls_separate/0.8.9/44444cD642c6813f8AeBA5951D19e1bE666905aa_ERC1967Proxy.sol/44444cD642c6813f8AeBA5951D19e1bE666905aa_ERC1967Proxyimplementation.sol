...
/**
    ...
    @author Gene A. Tsvigun
  */
contract GMMetadata is IGMMetadata, OwnableUpgradeable, UUPSUpgradeable, IUpgradeable, IOwnable {
    ...
    function owner() override(IOwnable, OwnableUpgradeable) public view returns (address){
        return OwnableUpgradeable.owner();
    }

    function transferOwnership(address owner_) override(IOwnable, OwnableUpgradeable) public onlyOwner {
