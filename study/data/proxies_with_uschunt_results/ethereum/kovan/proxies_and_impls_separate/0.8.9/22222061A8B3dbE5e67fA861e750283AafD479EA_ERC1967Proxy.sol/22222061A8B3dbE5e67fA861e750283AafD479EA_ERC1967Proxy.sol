...
/**
    ...
    @author Gene A. Tsvigun
  */
contract GMAccessControl is IGMAccessControl, AccessControlUpgradeable, UUPSUpgradeable, IUpgradeable {
    ...
    function setAgentOf(address agent, address user) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        require(!_isAgentOf(agent, user), "AccessControl: the user has already this exact agent assigned");
        agents[user] = agent;
    }
