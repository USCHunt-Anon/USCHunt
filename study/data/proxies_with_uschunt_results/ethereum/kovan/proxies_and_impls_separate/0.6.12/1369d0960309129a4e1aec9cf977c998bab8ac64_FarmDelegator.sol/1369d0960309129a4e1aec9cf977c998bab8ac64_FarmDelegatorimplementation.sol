...
contract FarmDelegate is Ownable, FarmStorageV1 {
    using SafeMath for uint256;
    ...
    function setHalvingPeriod(uint256 _block0, uint256 _block1)
        public
        onlyOwner
    {
    ...
    function setGanPerBlock(uint256 newPerBlock0, uint256 newPerBlock1)
        public
        onlyOwner
    {
        massUpdatePools();
