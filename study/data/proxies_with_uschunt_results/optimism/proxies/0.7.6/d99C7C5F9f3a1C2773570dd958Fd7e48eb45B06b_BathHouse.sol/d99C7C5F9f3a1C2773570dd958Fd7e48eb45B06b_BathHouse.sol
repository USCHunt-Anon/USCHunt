...
contract BathHouse {
    ...
    function adminWriteBathToken(ERC20 overwriteERC20, address newBathToken) external onlyAdmin {
    ...
    function bathTokenApproveSetMarket(address targetBathToken) external onlyAdmin {
